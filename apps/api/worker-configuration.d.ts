/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file ../../.dev.vars` (hash: 6e3500310d5e8e45e64dbf92543420e8)
...
declare namespace Cloudflare {
  ...
  interface Env {
    KV_AGENT_FACTS: KVNamespace;
    KV_AGENT_LOGS: KVNamespace;
    FRONTEND_BASE_URL: "https://core-dbi-database.hacolby.workers.dev";
    SODA_BASE: "https://data.sfgov.org/resource";
    AI_GATEWAY_NAME: "core-dbi-database";
    GEMINI_MODEL_NAME: "gemini-2.5-pro";
    OPENAI_MODEL_NAME: "gpt-4o";
    SANDBOX_BUCKET_NAME: "core-dbi-database";
    ...
    CLOUDFLARE_R2_SF_DBI_DATABASE_TOKEN: string;
    SODA_APP_TOKEN: string;
    ORCHESTRATOR: DurableObjectNamespace<
      import("./src/index").OrchestratorAgent
    >;
    DATA_EXPERT: DurableObjectNamespace<
      import("./src/index").DBIDataExpertAgent
    >;
    INSIGHTS: DurableObjectNamespace<import("./src/index").DBIInsightsAgent>;
    ANALYST: DurableObjectNamespace<import("./src/index").DBIDataAnalystAgent>;
    SANDBOX: DurableObjectNamespace<import("./src/index").Sandbox>;
    BUCKET_SANDBOX: R2Bucket;
    DB: D1Database;
    AI: Ai;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | "CLOUDFLARE_BROWSER_RENDER_TOKEN"
      ...
      | "R2_ENDPOINT_URL"
      | "CLOUFLARE_R2_TOKEN"
      | "CLOUDFLARE_R2_SF_DBI_DATABASE_TOKEN"
      | "SODA_APP_TOKEN"
    >
  > {}
}
